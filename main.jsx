        ...
        <footer id="contact" className={`py-16 px-6 border-t ${isDark ? 'bg-[#1a1a1a] border-[#606c38]/20' : 'bg-white border-[#606c38]/10'}`}>
            <div className="max-w-4xl mx-auto text-center space-y-8">
                ...
                <div className="flex justify-center gap-6">
                    <a href="#" className={`flex items-center gap-2 px-6 py-3 rounded-lg font-medium transition-colors ${isDark ? 'bg-[#283618] text-[#a3b18a] hover:bg-[#606c38] hover:text-white' : 'bg-[#e9edc9] text-[#606c38] hover:bg-[#606c38] hover:text-white'
                        }`}>
